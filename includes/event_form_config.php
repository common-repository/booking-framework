...
function event_form_config() {
	...
	switch($form_question_build) {
		case 'write_question':
			...
			<p>Enter a new question below. The type refers to the way a participant can respond to the question.</p>
			<ul>
			...
			<p>When using single or multiple, enter the possible values in the value box separated by commas.</p>
			<form name="newquestion" method="post" action="<?php $_SERVER['REQUEST_URI'];?>">
				...
				<input type="hidden" name="form_question_build" value="post_new_question" />
